...
<html>
    ...
    <body>
        <div class="container">
            <h1>Lista de alunos com o Email selecionado</h1>
            <table class="table">
                <tr>
                    <th>Código</th>
                    <th>Nome</th>
                ...
                <%
                    try {
                        ...
                        // Criando objeto para acessar a classe de operações
                        AlunoDAO objAlunoDAO = new AlunoDAO();

                        ArrayList<AlunoDTO> lista = objAlunoDAO.ConsultarPorEmail(request.getParameter("email"));
