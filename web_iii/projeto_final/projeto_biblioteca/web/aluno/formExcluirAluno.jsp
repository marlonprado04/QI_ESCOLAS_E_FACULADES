    ...
    <body>
        ...
        <form action="codeExcluirAluno.jsp" method="POST">
            ...
            <div class="form-container">
                ...
                <div class="form-group">
                    <label>Nome:</label>
                    <input class="form-control" type="text" name="nome" value="<%= request.getParameter("nome")%>" readonly>
                </div>

                <div class="form-group">
                    <label>Sobrenome:</label>
                    <input class="form-control" type="text" name="sobrenome" value="<%= request.getParameter("sobrenome")%>" readonly>
                </div>

                <div class="form-group">
                    <label>CPF:</label>
                    <input class="form-control" type="text" name="cpf" value="<%= request.getParameter("cpf")%>" readonly>
                </div>

                <div class="form-group">
                    <label>Telefone:</label>
                    <input class="form-control" type="text" name="telefone" value="<%= request.getParameter("telefone")%>" readonly>
                </div>

                <div class="form-group">
                    <label>Email:</label>
                    <input class="form-control" type="text" name="email" value="<%= request.getParameter("email")%>" readonly>
                </div>

                <div class="form-group">
                    <label>Curso: </label>
                    <input class="form-control" type="text" name="curso" value="<%= request.getParameter("curso")%>" readonly>
                </div>
