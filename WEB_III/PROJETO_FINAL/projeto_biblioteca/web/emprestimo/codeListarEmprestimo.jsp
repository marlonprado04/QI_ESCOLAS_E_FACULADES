            ...
            <div class="container">
                ...
                <nav class="navbar navbar-light bg-light float-right">
                    <form class="form-inline" action='codeConsultarEmprestimoPorData.jsp' method="POST">
                        <input class="form-control mr-sm-2" type="search" placeholder="Digite a data do empréstimo ou devolução..." aria-label="Search" name='data'>
                        <button class="btn btn-outline-primary my-2 my-sm-0" type="submit" onclick="location.href = 'codeConsultarEmprestimoPorData.jsp'">Pesquisar por data</button>
                    </form>
                </nav>
