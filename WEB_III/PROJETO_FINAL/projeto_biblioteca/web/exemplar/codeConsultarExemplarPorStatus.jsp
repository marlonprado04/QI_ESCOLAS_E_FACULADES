...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <h1 class="form-title">Resultado da busca de exemplares com status: <%=request.getParameter("status")%></h1>
            ...
            <table class="table table-bordered table-striped">
                ...
                <%
                    try {
                        ...
                        ArrayList<ExemplarDTO> lista = objExemplarDAO.ConsultarExemplarPorStatus(status);
